...
plant1:rotate('z', -30)
plant1:rotate('x', 40)
plant1:translate(2,4.5,4.5)  --outer: 44.5
...
plant2:rotate('z', 15)
plant2:rotate('x', 40)
plant2:translate(-2,5.5,2) -- inner: 38.25
...
grass1:rotate('z', 30)
grass1:rotate('x', 40)
grass1:translate(-2,4.2,4.5)  --outer: 44.5
...
grass2:rotate('z', -30)
grass2:rotate('x', 100)
grass2:translate(3,-4.2,3.7)  --outer: 44.5
...
ztrans_ship2 = 1.7*rootScale+0.33
-- ------------------------- Ship 2 &-----------------
shipNode2 = gr.node('shipNode2')
shipNode2:rotate('x', 50)
shipNode2:translate(-xtrans_ship, ytrans_ship, ztrans_ship2)
...
ship2Stripe1:translate(0, 0, -0.33)
...
StarTorsoNode:translate(0.35*rootScale+xtrans_ship,0.96*rootScale-ytrans_ship,1.56*rootScale-ztrans_ship2+0.8)
