...
public:
   ...
   * If an object name parameter is present in the .obj file, objectName is set
   * to that, otherwise objectName is set to the name of the .obj file.
   *
   ...
   */
  static void decode(const char *objFilePath, std::string &objectName,
