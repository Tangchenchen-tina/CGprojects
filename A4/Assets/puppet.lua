...
-- Torse = gr.mesh('torse', 'Assets/cylinder2.obj')
...
-- cloth1 = gr.mesh('cloth1', 'Assets/cube2.obj')
...
-- cloth2 = gr.mesh('cloth2', 'Assets/cube2.obj')
...
-- cloth3 = gr.mesh('cloth3', 'Assets/cube2.obj')
...
-- cloth4 = gr.mesh('cloth4', 'Assets/cube2.obj')
...
-- cloth5 = gr.mesh('cloth5', 'Assets/cube2.obj')
...
-- UpShoulder = gr.mesh('up_shoulder', 'Assets/sphere.obj')
...
-- BottomShoulder = gr.mesh('bottom_shoulder', 'Assets/cylinder2.obj')
...
-- Neck = gr.mesh('neck', 'Assets/cylinder2.obj')
...
LeftEyeSlash = gr.mesh('left_eyeslash', 'Assets/eyeslash.obj')
...
RightEyeSlash = gr.mesh('right_eyeslash', 'Assets/eyeslash.obj')
...
MidHead = gr.mesh('mid_head', 'Assets/cylinder2.obj')
...
Mouth = gr.mesh('mouth', 'Assets/mouth.obj')
...
MouthLine = gr.mesh('mouthline', 'Assets/mouth.obj')
...
Nose = gr.mesh('nose', 'Assets/nose.obj')
